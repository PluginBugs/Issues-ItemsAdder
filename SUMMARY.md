...
* [Compatibility with other plugins](developers/compatibility-with-other-plugins/README.md)
  * [Not compatible](developers/compatibility-with-other-plugins/not-compatible.md)
  * [Compatible](developers/compatibility-with-other-plugins/compatible/README.md)
    * [RPGMoney](developers/compatibility-with-other-plugins/compatible/rpgmoney.md)
    * [EpicBackpacks](developers/compatibility-with-other-plugins/compatible/epicbackpacks.md)
    * [Wailat](developers/compatibility-with-other-plugins/compatible/wailat.md)
    * [RPGMoney](developers/compatibility-with-other-plugins/compatible/rpgmoney-1.md)
    * [GriefPreventionStickFix](developers/compatibility-with-other-plugins/compatible/griefpreventionstickfix.md)
    * [BossShop](developers/compatibility-with-other-plugins/compatible/bossshop.md)
    * [RPG Chest Premium](developers/compatibility-with-other-plugins/compatible/rpg-chest-premium.md)
    * [ClueScrolls](developers/compatibility-with-other-plugins/compatible/cluescrolls.md)
    * [Recipe Control](developers/compatibility-with-other-plugins/compatible/recipe-control.md)
* [Addons/resources](developers/addons-resources.md)
